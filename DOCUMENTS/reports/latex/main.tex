...
\textbf{Algorithm~1: Kahn's Topological Sort for Workflow Execution}

\begin{lstlisting}[caption={Kahn's algorithm as implemented in \texttt{core/workflow\_engine.py}.}, label={lst:kahn}]
function execute_workflow(nodes, edges):
